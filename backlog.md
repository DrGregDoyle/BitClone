...
Deferred work from the former independent-node product roadmap. These items are retained for possible future
development but are not part of the active Bitcoin Math Lab release plan in [ROADMAP.md](ROADMAP.md).

Completed work remains in [archived_tickets.md](archived_tickets.md).
