...
from src.backup.crypto.curve_utils import ORDER, generator_exponent, scalar_multiplication, add_points
...
def verify_ecdsa(signature: tuple, message_hash: bytes, public_key: tuple) -> bool:
    ...
    p1 = generator_exponent(u1)
    p2 = scalar_multiplication(u2, public_key)
