...
__all__ = ["P2PK_Key", "P2PKH_Key", "P2MS_Key", "P2SH_Key", "P2WPKH_Key", "P2WSH_Key", "P2TR_Key"]
...
class P2PK_Key(ScriptPubKey):
    ...
    def __init__(self, pubkey: bytes):
        ...
        # --- Validation
        if len(pubkey) not in self.PUBKEY_LENGTHS:
...
class P2MS_Key(ScriptPubKey):
    ...
    def __init__(self, pubkeys: list, min_num: int = 0):
        ...
        # --- Validation
        if not all([len(pubkey) in [33, 65] for pubkey in pubkeys]):
